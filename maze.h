...
public:
  ...
  int getPathLength() const; // Function to get the path length
  int getNumVisitedNodes() const; // Function to get the number of visited nodes
...
protected:
  ...
  int mazeHeight;     // Stores the maze height
  int mazeWidth;      // Stores the maze width
  int pathLength;
  int numVisitedNodes;
};
